...
public class Admin_Page {
	...
	System.out.println("Total records With username:" + un + 
	" is:" + getRecords_found().getText()); 
	...
	System.out.println("Total records with User Role Admin:" 
	+ getRecords_found().getText()); 
	driver.navigate().refresh(); 
	} 
	public void searchByUserStatus() { 
		...
		System.out.println("Total Records enabled:" + 
		getRecords_found().getText()); 
	} 
}
